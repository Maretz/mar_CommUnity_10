...
case 2 :
  ...
  AND strlen ($_POST['txt']) <= $allgAr['Gtxtl'] ) {
    ...
    wd('index.php?gbook',$lang['insertsuccessful']);
	  ...
	  echo '<div class="alert alert-info">- '.$lang['donotpostsofast'].'<br>- '.sprintf($lang['gbooktexttolong'], $allgAr['Gtxtl']).'.<br>- '.$lang['plsfilloutallfields'].'<br><br><a class="btn btn-default" href="javascript:history.back()">&laquo; zur&uuml;ck</a></div>';
	}
  break;
case 'show' :
