...
switch($uum) {
  ...
  case 3 : # move topic in another forum
      ...
      echo '</select><br><br><input type="checkbox" name="alertautor" value="yes" /> Den Autor &uuml;ber das verschieben informieren?<br><br><input type="submit" class="btn btn-primary" value="Verschieben" name="sub"> <a class="btn btn-primary" href="javascript:history.back(1)">&laquo; zur&uuml;ck</a></form></div>';
    } else {
