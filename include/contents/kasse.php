...
while ($r = db_fetch_assoc($erg)) {
  ...
  if (has_right(-8, 'kasse')) {
    ...
    <a href="admin.php?kasse-'.$r['id'].'" rel="tooltip" title="editieren"><i class="fa fa-pencil-square-o"></i></a>
    <a href="index.php?kasse-d'.$r['id'].'" rel="tooltip" title="Eintrag löschen"><i class="fa fa-times-circle"></i></a>
    </span>';
  }
  $tpl->set_ar_out($r, 1);
}
