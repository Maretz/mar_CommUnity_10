...
if ($menu->get(2) == '' OR $menu->getA(2) == 'p') {
    ...
    if ($row['status'] == 2) {
        ...
        $hmenu = '<a href="?wars">Wars</a><b> &raquo; </b>Nextwars';
        $design = new design ($title , $hmenu);
        $design->header();
        ...
        if ($_SESSION['authright'] <= - 3) {
            ...
            $row['icq'] = '<i style="color:#FF0000;text-shadow: #c0c0c0 1px 1px 1px;" class="fa fa-lock"></i>';
            $row['mail'] = '<i style="color:#FF0000;text-shadow: #c0c0c0 1px 1px 1px;" class="fa fa-lock"></i>';
            $row['wo'] = '<i style="color:#FF0000;text-shadow: #c0c0c0 1px 1px 1px;" class="fa fa-lock"></i>';
            $row['txt'] = '<i style="color:#FF0000;text-shadow: #c0c0c0 1px 1px 1px;" class="fa fa-lock"></i>';
        }
