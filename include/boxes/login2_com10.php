...
$tpl = new tpl ( 'user/boxen_login2com10.htm' );
...
$q = "SELECT COUNT(DISTINCT a.id) FROM prefix_topics a
  ...
  ORDER BY c.time DESC";
      ...
      if ($lpost > '0') {
			$neuerpost = '<a class="btn btn-com10-2" href="index.php?forum-augt" data-toggle="tooltip" data-placement="top" title="Neue Beitr‰ge"><i class="fa fa-clipboard  login_blink_beitrag" aria-hidden="true"><sup>'.$lpost.'</sup></i></a>';
		} else {
		  $neuerpost = '<a class="btn btn-com10-2" href="index.php?forum-augt" data-toggle="tooltip" data-placement="top" title="Neue Beitr‰ge"><i class="fa fa-clipboard" aria-hidden="true"><sup>'.$lpost.'</sup></i></a>';
		}
	  ...
	  if ( $allgAr['Fpmf'] == 1 ) {
		  $erg = db_query("SELECT COUNT(id) FROM `prefix_pm` WHERE gelesen = 0 AND status < 1 AND eid = ".$_SESSION['authid']);
			...
			if ($check_pm > '0') {
			$nachrichten_link = '<a class="btn btn-com10-1" href="index.php?forum-privmsg" data-toggle="tooltip" data-placement="top" title="Nachrichten"><i class="fa fa-envelope-o login_blink_PM" aria-hidden="true"><sup>'.$check_pm.'</sub></i></a>';
		} else {
		  $nachrichten_link = '<a class="btn btn-com10-1" href="index.php?forum-privmsg" data-toggle="tooltip" data-placement="top" title="Nachrichten"><i class="fa fa-envelope-o" aria-hidden="true"><sup>'.$check_pm.'</sup></i></a>';
		}
		}		
		
$tpl->set ( 'UGALLERY', '<a class="btn btn-com10-3" href="index.php?user-usergallery-'.$_SESSION['authid'].'" data-toggle="tooltip" data-placement="top" title="Meine Gallery"><i class="fa fa-file-image-o" aria-hidden="true"><sup>'.$galerie.'</sup></i></a>');
